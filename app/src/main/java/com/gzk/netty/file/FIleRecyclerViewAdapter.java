...
public class FIleRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FIleRecyclerViewAdapter(ArrayList<String> dataSource) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (file != null && file.isFile()) {
            ...
            if (sub_ext.equalsIgnoreCase("pdf")) {
                icon.setImageResource(R.mipmap.pdf_icon);
                ...
                icon.setImageResource(R.mipmap.music_icon);
...
//                    }
//                } else {
                icon.setImageResource(R.mipmap.pic_icon);
//                }
                ...
                icon.setImageResource(R.mipmap.zip_icon);
